...
class TestMultiFunctionalRadar(TestCase):
    def setUp(self):
        ...
        first_target = Target(0, target_coordinates, target_velocities, target_type="Aerodynamic")
    ...
    def test_update_trace_list(self):
        ...
        first_target = Target(0, first_target_coordinates, first_target_velocities, target_type="Aerodynamic")
        # Параметры второй цели
        second_target_coordinates = np.array([30000., 4900., 30000.])
        second_target_velocities = np.array([300., 0., 10.])
        second_target = Target(0, second_target_coordinates, second_target_velocities, target_type="Aerodynamic")
        # Параметры третьей цели
        third_target_coordinates = np.array([55000., 4950., 3000.])
        third_target_velocities = np.array([300., 0., 10.])
        third_target = Target(0, third_target_coordinates, third_target_velocities, target_type="Aerodynamic")
